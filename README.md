...
A 3D interactive genealogical visualization of the Rothschild family tree, built with Three.js. This project maps the descendants of Mayer Amschel Rothschild, highlighting the family's expansion across Europe and their strategic intermarriages.
...
- **Y = -100**: Generation 5+ (Contemporary/Modern descendants)
...
The genealogical data and historical notes in this visualization were extracted directly from the following primary texts:
...
- Mayer Amschel's five sons: Amschel Mayer, Salomon Mayer, Nathan Mayer, Karl Mayer, and Jacob (James) Mayer.
...
- Branch specializations: Frankfurt (Amschel), Vienna (Salomon), London (Nathan), Naples (Karl), Paris (James).
...
├── README.md           # This file
├── images/             # Directory for historical portraits (add .jpg/.png files here)
│   └── placeholder.jpg # Placeholder for node headshots
...
- **Adding Images**: Place historical portraits in the `images/` directory and update the `headshotContainer` logic in `index.html` to point to the correct filenames.
...
This project is for educational and historical research purposes. The underlying data is derived from publicly available historical texts.